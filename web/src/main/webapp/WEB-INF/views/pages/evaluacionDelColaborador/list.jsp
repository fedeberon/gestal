                                            ...
                                            <tr>
                                                ...
                                                <c:choose>
                                                    <c:when test="${bo.estadoEvaluacion == 'PENDIENTE'}">
                                                        <td>
                                                            <a href="<c:url value='/evaluacionDelColaborador/update?id=${bo.id}'/>" title="Continuar evaluaci&oacute;n" class="btn btn-success" disabled>Continuar Evaluaci&oacute;n</a>
                                                    </c:when>
                                                </c:choose>
                                            </tr>
                                            </c:when>
