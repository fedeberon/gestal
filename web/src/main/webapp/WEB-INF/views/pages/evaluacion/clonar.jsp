...
<%--                                <form:hidden path="items[${status.index}].evaluacion.id" value='${evaluacion.id}'/>--%>
<%--                                <form:hidden path="items[${status.index}].id" value='${bo.id}'/>--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <button class="btn btn-outline-danger" id="borrar-indicador" type="button" disabled>Borrar</button>
