                    ...
                    <form:form modelAttribute="sucursal" action="${actionUrl}" method="POST">
                        <div class="form-style-8">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <form:input path="name" size="30" cssClass="form-control" required="true" id="inputSuccess1"/>
                            </div>
                            <div class="form-group mt-4">
                                <label class="form-control-label" for="inputSuccess1">Direccion</label>
                                <form:input path="direction" size="30" cssClass="form-control" id="inputSuccess1"/>
                            </div>
                            <div class="form-group mt-4">
                                <label class="form-control-label" for="inputSuccess1">Telefono</label>
                                <form:input path="telephone" size="30" cssClass="form-control" id="inputSuccess1"/>
                            </div>
                            <div class="form-group mt-4">
                                <label class="form-control-label" for="inputSuccess1">Email</label>
                                <form:input path="mail" size="30" cssClass="form-control" id="inputSuccess1"/>
                            </div>
                            <div class="form-group mt-4">
