  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      picture: function (lang) {
        return tplIconButton('fal fa-picture-o icon-picture', {
      ...
      link: function (lang) {
        return tplIconButton('fal fa-link icon-link', {
      ...
      video: function (lang) {
        return tplIconButton('fal fa-youtube-play icon-play', {
      ...
      table: function (lang) {
        var dropdown = '<ul class="note-table dropdown-menu">' +
                       ...
                       '</ul>';
        return tplIconButton('fal fa-table icon-table', {
      ...
      style: function (lang, options) {
        ...
        return tplIconButton('fal fa-magic icon-magic', {
      ...
      fontname: function (lang, options) {
        var items = options.fontNames.reduce(function (memo, v) {
          ...
          return memo + '<li><a data-event="fontName" href="#" data-value="' + v + '">' +
                          '<i class="fal fa-check icon-ok"></i> ' + v +
                        '</a></li>';
        }, '');
      ...
      color: function (lang) {
        var colorButtonLabel = '<i class="fal fa-font icon-font" style="color:black;background-color:yellow;"></i>';
      ...
      bold: function (lang) {
        return tplIconButton('fal fa-bold icon-bold', {
          event: 'bold',
          title: lang.font.bold
        });
      },
      italic: function (lang) {
        return tplIconButton('fal fa-italic icon-italic', {
          event: 'italic',
          title: lang.font.italic
        });
      },
      underline: function (lang) {
        return tplIconButton('fal fa-underline icon-underline', {
          event: 'underline',
          title: lang.font.underline
        });
      },
      strikethrough: function (lang) {
        return tplIconButton('fal fa-strikethrough icon-strikethrough', {
          event: 'strikethrough',
          title: lang.font.strikethrough
        });
      },
      superscript: function (lang) {
        return tplIconButton('fal fa-superscript icon-superscript', {
          event: 'superscript',
          title: lang.font.superscript
        });
      },
      subscript: function (lang) {
        return tplIconButton('fal fa-subscript icon-subscript', {
          event: 'subscript',
          title: lang.font.subscript
        });
      },
      clear: function (lang) {
        return tplIconButton('fal fa-eraser icon-eraser', {
          event: 'removeFormat',
          title: lang.font.clear
        });
      },
      ul: function (lang) {
        return tplIconButton('fal fa-list-ul icon-list-ul', {
          event: 'insertUnorderedList',
          title: lang.lists.unordered
        });
      },
      ol: function (lang) {
        return tplIconButton('fal fa-list-ol icon-list-ol', {
          event: 'insertOrderedList',
          title: lang.lists.ordered
        });
      },
      paragraph: function (lang) {
        var leftButton = tplIconButton('fal fa-align-left icon-align-left', {
          title: lang.paragraph.left,
          event: 'justifyLeft'
        });
        var centerButton = tplIconButton('fal fa-align-center icon-align-center', {
          title: lang.paragraph.center,
          event: 'justifyCenter'
        });
        var rightButton = tplIconButton('fal fa-align-right icon-align-right', {
          title: lang.paragraph.right,
          event: 'justifyRight'
        });
        var justifyButton = tplIconButton('fal fa-align-justify icon-align-justify', {
          title: lang.paragraph.justify,
          event: 'justifyFull'
        });

        var outdentButton = tplIconButton('fal fa-outdent icon-indent-left', {
          title: lang.paragraph.outdent,
          event: 'outdent'
        });
        var indentButton = tplIconButton('fal fa-indent icon-indent-right', {
        ...
        return tplIconButton('fal fa-align-left icon-align-left', {
      ...
      height: function (lang, options) {
        ...
        return tplIconButton('fal fa-text-height icon-text-height', {
      ...
      help: function (lang) {
        return tplIconButton('fal fa-question icon-question', {
      ...
      fullscreen: function (lang) {
        return tplIconButton('fal fa-arrows-alt icon-fullscreen', {
          event: 'fullscreen',
          title: lang.options.fullscreen
        });
      },
      codeview: function (lang) {
        return tplIconButton('fal fa-code icon-code', {
          event: 'codeview',
          title: lang.options.codeview
        });
      },
      undo: function (lang) {
        return tplIconButton('fal fa-undo icon-undo', {
          event: 'undo',
          title: lang.history.undo
        });
      },
      redo: function (lang) {
        return tplIconButton('fal fa-repeat icon-repeat', {
          event: 'redo',
          title: lang.history.redo
        });
      },
      hr: function (lang) {
        return tplIconButton('fal fa-minus icon-hr', {
    ...
    var tplPopovers = function (lang, options) {
      var tplLinkPopover = function () {
        var linkButton = tplIconButton('fal fa-edit icon-edit', {
          title: lang.link.edit,
          event: 'showLinkDialog',
          hide: true
        });
        var unlinkButton = tplIconButton('fal fa-unlink icon-unlink', {
      ...
      var tplImagePopover = function () {
        ...
        var removeButton = tplIconButton('fal fa-trash-o icon-trash', {
