$(document).ready(function(){
    ...
    $(this).on('click', '.agregar-item-indicador', function(){
        ...
        html += '<div class="col-md-3"><select  style="height: 60px" id="0" name="items['+indiceIndicador+'].score" id="select_1" class="form-control"> <option hidden selected> Peso</option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option></select></div>';
